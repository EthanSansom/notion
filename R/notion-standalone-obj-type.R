...
# This file has been edited to include "notion_error" and "notion_error_{class}"
# class information in the raised error conditions. `stop_input_type()` is the
...
stop_input_type <- function(
  ...
  abort(
    message,
    ...,
    # This is the only {notion} revision to this script
